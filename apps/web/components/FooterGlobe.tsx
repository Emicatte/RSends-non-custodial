...
export const COLUMNS = [
  ...
  { title: 'Company', links: [
    ...
    { label: 'Contact', href: 'mailto:emiliocatteddu@gmail.com' },
...
const SOCIALS = [
  ...
  { label: 'Telegram', icon: <TelegramIcon />, url: 'https://t.me/Emicatte26' },
]
      ...
      <div className={styles.linksBar}>
        ...
        <div className={styles.bottomBar}>
          <div className={styles.bottomLeft}>
            ...
            <span style={{ opacity: 0.3 }}>&middot;</span>
            <a href="mailto:emiliocatteddu@gmail.com" className={styles.bottomTextLink} style={{ textDecoration: 'none', color: 'inherit' }}>emiliocatteddu@gmail.com</a>
          </div>
