...
/**
 * Editorial callout with a left side-bar. Used for HMAC notes, "shown once"
 * warnings, and not-yet-implemented (501) markers.
 */
  ...
  return (
    <div className={`my-5 flex gap-0 overflow-hidden rounded-lg ${s.bg}`}>
      ...
      <div className="px-4 py-3.5">
        ...
        <div className="font-display text-[13.5px] leading-relaxed text-ink/70">
          {children}
        </div>
      </div>
    </div>
