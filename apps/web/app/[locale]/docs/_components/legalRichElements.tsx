...
export const richElements = {
  ...
  br: () => <br />,
  privacyMail: (chunks: ReactNode) => <a href="mailto:emiliocatteddu@gmail.com">{chunks}</a>,
  legalMail: (chunks: ReactNode) => <a href="mailto:emiliocatteddu@gmail.com">{chunks}</a>,
  complianceMail: (chunks: ReactNode) => <a href="mailto:emiliocatteddu@gmail.com">{chunks}</a>,
